    ...
    useEffect(() => {
      axios
        ...
        .then((res) => {
          ...
          const categoriesFromData = res.data.map((item: any) => item.category);
          console.log('Kategori produk dari backend:', [...new Set(categoriesFromData)]);
        })
        .catch((err) => {
                ...
                {productList.map((product, i) => (
                  ...
                  >
                    <img
                      src={product.image}
                      alt={product.name}
                      className="w-24 h-24 object-cover mb-2 self-center"
                    />
