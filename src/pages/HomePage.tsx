      ...
      <div className="bg-[#FFF7E2] min-h-screen text-[#1E2B32]">
        ...
        <main className="max-w-[1300px] mx-auto px-6">
          <motion.section className="py-8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            <img src={homePageImage} alt="Hero" className="rounded-xl w-full h-[380px] object-cover shadow-sm" />
          </motion.section>
          ...
          <motion.section className="py-10" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <motion.div className="flex flex-wrap justify-center md:justify-between gap-y-6 gap-x-4">
              {categories.map((item, i) => (
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`flex flex-col items-center w-[110px] text-center cursor-pointer transition-all ${
          ...
          <motion.section className="py-10" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-6 justify-start"
